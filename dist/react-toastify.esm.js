...
function dispatchToast(content, options) {
  if (isAnyContainerMounted()) {
    ...
    if (lazy && canUseDom) {
      ...
      if (isReact18) {
        root.render(createElement(ToastContainer, Object.assign({}, containerConfig)));
      } else {
        ReactDOM.render(createElement(ToastContainer, Object.assign({}, containerConfig)), containerDomNode);
      }
    }
  }
